# Brief de producción — Episodio 09: Esto es solo el aperitivo
...
- [ ] El guion de este episodio: `scripts/ep09_esta-semana.md`
...
Tema del episodio: «Esto es solo el aperitivo». Ángulo: Hoy te di el mapa: el qué y el porqué. El cómo lo bajamos a tierra esta semana, paso a paso..
...
```
data/audio/ep09_esta-semana.mp3
```
...
---
*Ángulo:* Hoy te di el mapa: el qué y el porqué. El cómo lo bajamos a tierra esta semana, paso a paso.
